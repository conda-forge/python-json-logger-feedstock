...
pixi add python-json-logger
# for installing globally
pixi global install python-json-logger
```
...
It is possible to list all of the versions of `python-json-logger` available on your platform:
...
```
pixi search python-json-logger --channel conda-forge
```
